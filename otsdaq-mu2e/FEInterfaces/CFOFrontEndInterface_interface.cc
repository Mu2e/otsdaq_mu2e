...
{
	__COUT__ << "CFO firmware version . (0x9004) = 0x" << std::hex << registerRead(0x9004) << __E__;
	__COUT__ << "CFO link enable .      (0x9114) = 0x" << std::hex << registerRead(0x9114) << __E__;
	__COUT__ << "CFO SERDES reset .     (0x9118) = 0x" << std::hex << registerRead(0x9118) << __E__;
	__COUT__ << "CFO SERDES unlock error(0x9124) = 0x" << std::hex << registerRead(0x9124) << __E__;
	__COUT__ << "CFO PLL locked .       (0x9128) = 0x" << std::hex << registerRead(0x9128) << __E__;
	__COUT__ << "CFO SERDES Rx status . (0x9134) = 0x" << std::hex << registerRead(0x9134) << __E__;
	__COUT__ << "CFO SERDES reset done .(0x9138) = 0x" << std::hex << registerRead(0x9138) << __E__;
	__COUT__ << "CFO SERDES Rx CDR lock (0x9140) = 0x" << std::hex << registerRead(0x9140) << __E__;
	__COUT__ << "CFO SERDES ref clk freq(0x9160) = 0x" << std::hex << registerRead(0x9160) << " = " 
...
void CFOFrontEndInterface::configure(void)
{
	...
	const int reset_tx					= 0;  // 1 = yes, 0 = no
	...
	if ( (config_step%number_of_dtc_config_steps) == 0 ) {
		...
		__COUT__ << "CONFIGURE (end of chain):  CFO status" << __E__;
		readStatus();
		
		if (getLinkStatus() == 1) {
			
			__COUT__ << "CFO links OK" << __E__;
			
		} else {
			
			__COUT__ << "CFO links not OK = " << registerRead(0x9140) << __E__;
		}
