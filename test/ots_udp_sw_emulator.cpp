...
int main(int argc, char *argv[])
{
	...
	cout << "sw: Line " << __LINE__ << ":::" << "Type of Test: " << type << endl;
    ...
    case 1:
    	...
    	cout << "sw: Line " << __LINE__ << ":::" << "Value read: " << hex << val << endl;
    ...
    case 2:
     	...
     	//read data packets ///////////////////////////////////////////////////////////
		{
			...
			for(int i=0; i<sz; ++i)
			{
				...
				memcpy((void *)&val,(void *)&buff[TX_DATA_OFFSET],8);
		    	cout << "sw: Line " << __LINE__ << ":::" << "Value read: " << val << endl;
			}
		}
    	...
    	break;
    default:
    	cout << "sw: Line " << __LINE__ << ":::" << "INVALID Type of Test: " << type << endl;
    }
