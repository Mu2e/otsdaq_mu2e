...
args= do_help= opt_v=0; opt_w=0; opt_develop=0; opt_skip_extra_products=0; opt_no_pull=0; opt_padding=0; opt_no_kmod=0; opt_all_packages=0; opt_no_view=0; opt_dev_only=0; opt_no_auto_upstream=0; opt_g4=0
while [ -n "${1-}" ];do
