...
#
# cd my/install/path
# wget https://cdcvs.fnal.gov/redmine/projects/otsdaq-utilities/repository/revisions/develop/raw/tools/quick_mu2e_trigger_ots_install.sh -O quick_mu2e_trigger_ots_install.sh --no-check-certificate
# chmod 755 quick_mu2e_trigger_ots_install.sh
# source quick_mu2e_trigger_ots_install.sh
#
...
rm -rf ots
rm quick_mu2e_trigger_ots_install.zip
wget https://otsdaq.fnal.gov/downloads/quick_mu2e_trigger_ots_install.zip
unzip quick_mu2e_trigger_ots_install.zip
cd ots
